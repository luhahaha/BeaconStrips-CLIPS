 ...
 *
 * classe che contiene il TU18 (Test di Unità 18). Verifica che la richiesta di effettuare la registrazione del profilo dell'utente sia effettuata correttamente.
   ...
   public void registration() {
      ...
      LoginManager.sharedManager(context).registration("prova34@gmail.com", "Prova34", "prova34", new AbstractDataManagerListener<Boolean>() {
         public void onResponse(Boolean response) {
            ...
            Log.d("RegistrationTest", "   Token del file: " + preferences.getString("token", ""));
            Log.d("RegistrationTest", "   Token di loggedUser: " + loggedUser.token);
            Log.d("RegistrationTest", "   Email del file: " + preferences.getString("email", ""));
            Log.d("RegistrationTest", "   Email di loggedUser: " + loggedUser.email);
            Log.d("RegistrationTest", "   Username del file: " + preferences.getString("username", ""));
            Log.d("RegistrationTest", "   Username di loggedUser: " + loggedUser.username);
         }
