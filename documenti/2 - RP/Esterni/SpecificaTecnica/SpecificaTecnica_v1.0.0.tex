...
\begin{diario}
	\modifica{Viviana Alessio}{\PRJ}{Stesura sezione "\hyperref[attivita]{Diagrammi delle attività}"}{2016-05-13}{0.1.0}
	\modifica{Viviana Alessio}{\PRJ}{Stesura appendice "\hyperref[pattern]{Design pattern utilizzati}"}{2016-05-12}{0.1.0}
