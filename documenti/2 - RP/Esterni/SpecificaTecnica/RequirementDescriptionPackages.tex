...
\begin{tabella}{!{\VRule}c!{\VRule}X[c,b,c]!{\VRule}c!{\VRule}}
	...
	R0F1  & L'utente deve poter possedere un account registrato nel database &    \cellacaporiga{dataserver \\ CLIPS::server  \\} \\
	...
	R0F1.2.6  &  Se i dati confermati dall'utente sono validi, il suo account viene registrato  & \cellacaporiga{CLIPS::CLIPS::client ::authentication  \\
		CLIPS::client  \\ CLIPS::client::data \\ dataserver \\ CLIPS::server  \\ CLIPS::client::data:urlrequest \\ CLIPS::server::urlrequesthandler} \\
	...
	R0F1.2.7.1 & L'utente ha inserito un'email non valida   & \cellacaporiga{CLIPS::CLIPS::client ::authentication  \\
		CLIPS::client  \\ dataserver \\ CLIPS::server  \\ CLIPS::client::data:urlrequest \\ CLIPS::server::urlrequesthandler} \\
