...
\begin{figure}[H] 
\centering 
\includegraphics[scale=0.4]{img/UC1.png} 
...
\begin{figure}[H] 
\centering 
\includegraphics[scale=0.4]{img/UC10.png} 
\caption{Caso d'uso UC10 - Visualizza edificio} 
 \end{figure} 
\desc{l'utente visuaizza i dettagli di un edificio abilitato.}\\\\ 
...
\scen{l'utente visuaizza i dettagli di un edificio abilitato. In particolare visualizza:
\begin{itemize}
...
\begin{figure}[H] 
\centering 
\includegraphics[scale=0.4]{img/UC11.png} 
...
\pre{l'utente si trova nella pagine di registrazione.}\\\\ 
...
\desc{l'utente visualizza un messaggio d'errore perché ha inserito un'email  non valida che non soddisfa il \Req{1.2.7.1.1}.}\\\\ 
\pre{l'utente ha inserito un'email non valida.}\\\\ 
\post{l'utente viene notificato di aver inserito un'email non valida.}\\\\ 
\scen{l'utente visualizza un messaggio d'errore perché ha inserito un'email  non valida che non soddisfa il \Req{1.2.7.1.1}}\\\\ 
\att{Utente non autenticato.}
...
\begin{figure}[H] 
\centering 
\includegraphics[scale=0.4]{img/UC20.png} 
...
\begin{figure}[H] 
\centering 
\includegraphics[scale=0.4]{img/UC3.png} 
...
\begin{figure}[H] 
\centering 
\includegraphics[scale=0.4]{img/UC3_1.png} 
...
\begin{figure}[H] 
\centering 
\includegraphics[scale=0.4]{img/UC3_1_2.png} 
...
\desc{l'utente visualizza le informazioni che deve sapere in preparazione alla prova, solitamente le istruzioni (questo punto il tempo per la prova non scorre ancora).}\\\\ 
\pre{l'utente è in procinto di iniziare la prova.}\\\\ 
\post{l'utente ha ricevuto informazioni su come procedere per la prova.}\\\\ 
\scen{l'utente visualizza le informazioni che deve sapere in preparazione alla prova, solitamente le istruzioni (questo punto il tempo per la prova non scorre ancora)}\\\\ 
\att{Utente.}
...
\begin{figure}[H] 
\centering 
\includegraphics[scale=0.4]{img/UC3_2.png} 
...
\begin{figure}[H] 
\centering 
\includegraphics[scale=0.4]{img/UC4.png} 
...
\begin{figure}[H] 
\centering 
\includegraphics[scale=0.4]{img/UC5.png} 
...
\item \UC{UC13} la connessione ad internet non è attiva e viene visualizzato l'invito ad attivarlo}\\\\ 
\att{Utente.}

\casoduso{UC7}{Cerca edifici per raggio} 
\begin{figure}[H] 
\centering 
\includegraphics[scale=0.4]{img/UC7.png} 
...
\casoduso{UC8}{Cerca edifici per vicinanza} 
\begin{figure}[H] 
\centering 
\includegraphics[scale=0.4]{img/UC8.png} 
\caption{Caso d'uso UC8 - Cerca edifici per vicinanza} 
 \end{figure} 
\desc{l'utente cerca gli edifici abilitati per vicinanza.}\\\\ 
\pre{da aggiungere.}\\\\ 
\post{da aggiungere.}\\\\ 
\scen{l'utente cerca gli edifici abilitati per vicinanza}\\\\ 
\att{Utente.}

\casoduso{UC8.1}{Inserisci numero di edifici vicini da visualizzare} 
\desc{l'utente inserisce il numero di edifici abilitati più vicini a lui che vuole visualizzare.}\\\\ 
\pre{l'utente è alla ricerca degli edifici abilitati.}\\\\ 
\post{l'utente ha inserito il numero di edifici abilitati più vicini che vuole visualizzare.}\\\\ 
\scen{l'utente inserisce il numero di edifici abilitati più vicini a lui che vuole visualizzare}\\\\ 
\att{Utente.}
