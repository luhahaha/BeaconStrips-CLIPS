...
\section{Gestione amministrativa della revisione}
	...
	\subsection{Comunicazione e risoluzione delle anomalie}
		...
		\begin{itemize}
			...
			\item\ l'uscita dal \gl{range} di accettazione degli indici di misurazione, descritti nella \hyperref[sec:3.9]{sottosezione 3.9};
			...
			\item\ un'incongruenza del codice con il design \gl{prodotto}.
		\end{itemize}
