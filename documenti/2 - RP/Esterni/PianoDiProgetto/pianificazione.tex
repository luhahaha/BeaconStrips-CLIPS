\section{Pianificazione} 
	...
	Per rendere più controllabile lo sviluppo del \gl{progetto} si è deciso di dividere il lavoro in sei fasi specifiche, le quali vengono riportate nella seguente tabella con le relative date di inizio e di fine.
		
		\begin{tabella}{!{\VRule}c!{\VRule}c!{\VRule}c!{\VRule}c!{\VRule}} %date non standard \gl{ISO}
				
			\intestazionethreecol{Fase}{Data di inizio}{Data di fine}
	...
	\end{itemize}
		...
		% \gantt{img/gantt/A}{Diagramma di \gl{Gantt} delle attività - Fase A}
		
		\begin{figure}[!h]
			\centering
			\includegraphics[height=12cm, width=15cm]{img/gantt/A} 
			\caption{Diagramma di \gl{Gantt} delle attività - Fase A}
		\end{figure}
		
	\subsection{Fase B - Consolidamento dei Requisiti}
	\begin{center}
		\textbf{Data di inizio}: 2016-04-19 \\
		\textbf{Data di fine}: 2016-04-28 \\
	\end{center}
	Questa fase inizia al termine della fase A, ovvero dopo la Revisione dei Requisiti, e termina con un incontro con il \gl{proponente}. \\ 
	...
	\end{itemize}
		...
		\subsubsection{Diagramma di \gl{Gantt} delle attività}
		\gantt{img/gantt/AD}{Diagramma di \gl{Gantt} delle attività - Fase B}
		
	\subsection{Fase C - Progettazione Architetturale}
	\begin{center}
	...
	Il processo principale di questa fase è:
		...
		\end{itemize}
		\subsubsection{Diagramma di \gl{Gantt} delle attività}
		\gantt{img/gantt/PA}{Diagramma di \gl{Gantt} delle attività - Fase C}
		
		
		
	\subsection{Fase D - Progettazione di dettaglio e codifica}
	\begin{center}
	...
	I processi principali di questa fase sono: 
		...
		\end{itemize}
		\subsubsection{Diagramma di \gl{Gantt} delle attività}
		% \gantt{img/gantt/PDC}{Diagramma di \gl{Gantt} delle attività - Fase PDC}
		
		\begin{figure}[!h]
			\centering
			\includegraphics[height=12cm, width=15cm]{img/gantt/PDC} 
			\caption{Diagramma di \gl{Gantt} delle attività - Fase D}
		\end{figure}
		
	\subsection{Fase E - Consolidamento della codifica}
	\begin{center}
	...
	I processi principali di questa fase sono: 
		...
		\end{itemize}
		\subsubsection{Diagramma di \gl{Gantt} delle attività}
		% \gantt{img/gantt/RD}{Diagramma di \gl{Gantt} delle attività - Fase RD}
		
		\begin{figure}[!h]
			\centering
			\includegraphics[height=12cm, width=15cm]{img/gantt/RD} 
			\caption{Diagramma di \gl{Gantt} delle attività - Fase E}
		\end{figure}
		
	\subsection{Fase F - Validazione}
	\begin{center}
	...
	I processi principali di questa fase sono:
		...
		\end{itemize}
		\subsubsection{Diagramma di \gl{Gantt} delle attività}
		% \gantt{img/gantt/V}{Diagramma di \gl{Gantt} delle attività - Fase V}
		
		\begin{figure}[!h]
			\centering
			\includegraphics[height=11cm, width=15cm]{img/gantt/V} 
			\caption{Diagramma di \gl{Gantt} delle attività - Fase F}
		\end{figure}
