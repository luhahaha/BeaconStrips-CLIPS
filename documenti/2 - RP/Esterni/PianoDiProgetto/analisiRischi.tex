\section{Analisi dei rischi} 
	...
	\subsection{Livello tecnologico}
		\subsubsection{Uso di tecnologie e strumenti}
			\begin{itemize}
				...
				\item \textbf{Riscontro effettivo}: Attualmente i membri del team hanno studiato e testato gli strumenti da utilizzare e non si è riscontrato alcun rallentamento significativo alla progettazione.
			\end{itemize}	
		...
		\subsubsection{Danneggiamento strumentazione \gl{hardware}}
			\begin{itemize}
				...
				\item \textbf{Riscontro effettivo}: non c'è stato alcun guasto di strumentazione hardware all'interno del team.
			\end{itemize}
		...
		\begin{itemize}
			...
			\item \textbf{Riscontro effettivo}: durante l'installazione del software Trender all'interno del server dato in dotazione da \PROPONENTE, si sono riscontrate difficoltà, che sono state successivamente risolte contattando il produttore e intervenendo sul codice sorgente. Non si sono riscontrati ritardi significativi nell'avanzamento della progettazione.
		\end{itemize}
	...
	\subsection{Livello personale}
		...
		\begin{itemize}
			...
			\item \textbf{Riscontro effettivo}: durante il periodo di analisi di dettaglio Tommaso è stato impegnato in un lavoro extra-curricolare che lo ha sottrato a qualche ora di attività di \AN; grazie alla sua segnalazione si è deciso di assegnare le ore mancanti ad altri componenti del team provvedendo a farle recuperare a Tommaso nei periodi successivi.
		\end{itemize}
		...
		\begin{itemize}
			...
			\item \textbf{Riscontro effettivo}: non si sono riscontrati problemi di questo tipo.
		\end{itemize}
	...
	\subsection{Livello organizzativo}
		...
		\begin{itemize}
			...
			\item \textbf{Riscontro effettivo}: il team non era a conoscenza che la consegna dell'offerta tecnico-economica fosse anticipata (1 aprile) rispetto alla data di consegna della documentazione per la RP (11 aprile); si è proceduto inviando una mail al Committente per segnalare il problema, il quale ha posticipato la data (7 aprile); questo evento ha prodotto un'accelerazione nell'ultimazione dei documenti, non creando però gravi conseguenze. 
		\end{itemize}
		...
		\begin{itemize}
			...
			\item \textbf{Riscontro effettivo}: si è discusso di alcuni dubbi sui requisiti del progetto con il Proponente durante gli incontri effettuati facilitando la parte iniziale dell'analisi dei requisiti.
		\end{itemize}
