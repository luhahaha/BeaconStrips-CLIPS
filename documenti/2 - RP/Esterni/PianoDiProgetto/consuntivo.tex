...
\begin{tabella}{!{\VRule}c!{\VRule}c!{\VRule}c!{\VRule}}
	...
	\textbf{Totale (differenza)} & 0 & -\euro8,00\\
...
\subsubsection{Conclusioni}
Il team ha impiegato quattro ore in più in attività di progettazione, tre in meno in attività di analisi e una in meno in attività di amministrazione. Non sono state utilizzate ore in più rispetto a quanto preventivato, ma sono stati risparmiati \euro8,00 grazie al cambio delle ore mostrato sopra.

\subsubsection{Preventivo a finire}
Grazie alle ammortizzazioni effettuate al termine del periodo di Analisi di Dettaglio, il preventivo supera il consuntivo: il bilancio quindi è in positivo di \euro8,00.
Il team potrà utilizzare questi \euro8,00 nei periodi successivi nel caso fosse necessario un maggiore dispendio di ore.