...
\Req{R2F6.2.1.4} & L'utente può visualizzare una breve descrizione sull'edificio e sul tipo di percorsi presenti. & {\color{reqNonSoddisfatto} Non soddisfatto}\\ 
\Req{R2F8} & Al primo utilizzo l'app mostra all'utente un tutorial introduttivo. & {\color{reqNonSoddisfatto} Non soddisfatto}\\ 
\Req{R2V2.2} & L'applicativo verrà sviluppato per dispositivi iOS con almeno la versione 9.0. & {\color{reqNonSoddisfatto} Non soddisfatto}\\ 
\hiderowcolors
