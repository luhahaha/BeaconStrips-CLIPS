		...
		\begin{itemize}
			\item \textbf{Vantaggi:}
				\begin{itemize}
					...
					\item ad ogni push di codice su GitHub l'intero progetto viene compilato e i test vengono eseguiti evidenziando subito se qualche commit ha introdotto errori/regressioni
