...
\classeAttributo{searchByDistance}{boolean}{indica se la richiesta al server deve ritornare gli edifici più vicini secondo un numero massimo o una distanza massima entro cui essi sono presenti}
\end{classeAttributi}
\begin{classeRelazioni}
