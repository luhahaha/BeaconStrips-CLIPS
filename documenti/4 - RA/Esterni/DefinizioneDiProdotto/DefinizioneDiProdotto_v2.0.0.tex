...
\setlist[itemize,2]{label=\rightarrow}
...
\newenvironment{compClassi} [1] {
	\subsubsection{Classi} {#1}
	\begin{itemize}[leftmargin=*]
} {
	\end{itemize}
}
\newenvironment{classe} [1] {
	\item[] \paragraph{\texttt{#1}} \\
...
\begin{document}
	...
	\begin{diario}
	\modifica{Andrea Grendene}{\RES}{Approvazione documento}{2016-09-08}{2.0.0}
	\modifica{Viviana Alessio}{\PRJ}{Verifica documento}{2016-09-07}{1.5.0}
	\modifica{Matteo Franco}{\PRJ}{Aggiunta tabella tracciamento classi requisiti}{2016-09-07}{1.4.0}
	\modifica{Tommaso Panozzo}{\PRJ}{Descrizione server - DB}{2016-09-04}{1.3.0}
	\modifica{Luca Soldera}{\PRJ}{Verifica documento}{2016-09-03}{1.2.0}
	\modifica{Andrea Grendene}{\PRJ}{Spiegazione scelta singleton}{2016-09-01}{1.1.2}
	\modifica{Viviana Alessio}{\PRJ}{Aggiunta diagrammi di sequenza registrazione e login}{2016-09-01}{1.1.1}
	\modifica{Viviana Alessio}{\PRJ}{Riformattazione descrizione componenti}{2016-09-01}{1.1.0}
   ...
   \include{stTrackingClassRequirement}

   \include{stTrackingRequirementClass}

   \include{descrizioneScoringAlgorithm}

   \include{specificaJSON}
