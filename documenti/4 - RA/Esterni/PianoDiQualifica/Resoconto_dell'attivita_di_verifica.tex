...
\label{resocontoDellAttivitaDiVerifica}
	...
	\label{periodoDiProgettazioneArchitetturale}
		...
		\subsection{Soddisfacimento metriche}
			...
			Di seguito viene riportata la tabella riassuntiva della copertura del codice.
			\begin{tabella}{!{\VRule}l!{\VRule}c!{\VRule}l!{\VRule}}
				\intestazionethreecol{Componente}{Percentuale}{Esito}
				urlrequest & 92\% & {\color[rgb]{0.44,0.74,0.48} Superato} \\
				datamanager & 94 \% & {\color[rgb]{0.44,0.74,0.48} Superato}\\
				data & 92\% &  {\color[rgb]{0.44,0.74,0.48} Superato}\\
				pathprogress & 29\% &{\color[rgb]{1,0,0} Non Superato} \\
				authentication & 0\% & {\color[rgb]{1,0,0} Non Superato}\\
				building & 0\% & {\color[rgb]{1,0,0} Non Superato}\\
				games & 0\% & {\color[rgb]{1,0,0} Non Superato}\\
				savedresults & 0\% & {\color[rgb]{1,0,0} Non Superato}\\
				utility & 0\% & {\color[rgb]{1,0,0} Non Superato}\\
				server & 64\%& {\color[rgb]{1,0,0} Non Superato}
				\caption{Tabella copertura del codice}
				\end{tabella}
