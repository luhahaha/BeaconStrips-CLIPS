  ...
  \label{qualitaDiProdotto}
	...
	\label{manutenibilita}
		...
		\begin{itemize}
			...
			\item \textbf{Metrica:}\ il \gl{prodotto} deve raggiungere la sufficienza in tutte le metriche descritte nella sezione \hyperref[metrichePerIlCodice]{Metriche per il codice}.
			\item \textbf{Strumenti:}\ si vedano le \NPdoc.
		\end{itemize}
