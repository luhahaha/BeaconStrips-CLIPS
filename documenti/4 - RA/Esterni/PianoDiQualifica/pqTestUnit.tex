\begin{tabella}{!{\VRule}l!{\VRule}X[1,b,l]!{\VRule}l!{\VRule}c!{\VRule}}
	...
	TU30 & Si verifica che la costruzione dei test avvenga correttamente & N.I. & {\color[rgb]{0,1,0} Superato} \\ %data.TestBuilder
	TU31 & Si verifica che il check dell'esattezza della risposta dei quiz avvenga in modo corretto & N.I. & {\color[rgb]{0,1,0} Superato} \\ % metodo check delle classi derivate da AbstractQuiz
	TU32 & Si verifica che la costruzione dell'algoritmo per il calcolo del punteggio del test avvenga correttamente & N.I. & {\color[rgb]{0,1,0} Superato} \\ %data.ScoringAlgorithmFactory
	TU33 & Si verifica che i metodi di supporto di Path, PathProgress e ProofResult funzionino correttamente & N.I. & {\color[rgb]{0,1,0} Superato} \\ %data.PathProgress
	TU34 & Si verifica che il bottone possa essere cliccato e porti all'azione desiderata & N.I. & {\color[rgb]{0,1,0} Superato} \\ %setButtonInfoProfilo() in Authentication
