...
\label{esitoDelleRevisioni}
	...
	\label{revisioneDiQualifica}
		\begin{itemize}
			...
			\item \textbf{Specifica Tecnica:}\ le parti relative al \gl{MVC}\ sono state sostituite con quelle del \gl {MVP}; è stata poi modificata l'immagine del Singleton e infine sono state cambiate le descrizioni relative all'architettura.
