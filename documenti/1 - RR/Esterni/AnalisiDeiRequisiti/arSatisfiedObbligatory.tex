\begin{tabella}{!{\VRule}l!{\VRule}l!{\VRule}r!{\VRule}}\intestazionethreecol{Requisito}{Descrizione}{Soddisfatto}R0F1 & L'utente deve poter possedere un account registrato nel database. & {\color{reqNonSoddisfatto} Non soddisfatto}\\ 
