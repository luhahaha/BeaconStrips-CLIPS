\begin{tabella}{!{\VRule}l!{\VRule}l!{\VRule}r!{\VRule}}\intestazionethreecol{Requisito}{Descrizione}{Soddisfatto}R1F3.1.1.3 & L'utente può chiedere aiuto se non riesce a trovare la prima stazione o se pensa che il dispositivo non riesca a rilevare il beacon corretto. & {\color{reqNonSoddisfatto} Non soddisfatto}\\ 
