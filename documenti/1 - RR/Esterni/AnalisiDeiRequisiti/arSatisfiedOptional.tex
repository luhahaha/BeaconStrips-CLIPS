\begin{tabella}{!{\VRule}l!{\VRule}l!{\VRule}r!{\VRule}}\intestazionethreecol{Requisito}{Descrizione}{Soddisfatto}R2F3.1.1.4 & Il dispositivo può sfruttare dei beacon aggiuntivi ed estranei al percorso per segnalare all'utente la distanza tra lui e la stazione. & {\color{reqNonSoddisfatto} Non soddisfatto}\\ 
