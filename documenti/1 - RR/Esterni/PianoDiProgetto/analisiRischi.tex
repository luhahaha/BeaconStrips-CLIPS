\section{Analisi dei rischi} 
	...
	\begin{enumerate}
		...
		\item \textbf{Pianificazione di controllo}: verranno delineati i metodi grazie ai quali si cercherà di evitare che il rischio si verifichi. %punto e virgola
	...
	\subsection{Livello tecnologico}
		...
		\subsubsection{Danneggiamento strumentazione hardware}
			\begin{itemize}
				...
				%fruitore
				%repository maschile o femminile?
			\end{itemize}
