...
\begin{enumerate}
  ...
  \textbf{Risposta}: \\
  Non c'è nessun problema se volete utilizzare uno strumento che preferite: semplicemente noi utilizziamo una repository per il versionamento di tipo \gl{SVN} e se volete possiamo darvi una parte di questa; naturalmente se utilizzerete una vostra repository vi chiederemo di darci modo di accedervi;
\end{enumerate}
