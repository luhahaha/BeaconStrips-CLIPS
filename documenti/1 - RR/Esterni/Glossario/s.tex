...
\lettera{Scala}{Scala (da Scalable Language) è un linguaggio studiato per integrare le caratteristiche e funzionalità dei \gl{linguaggi orientati agli oggetti} e dei \gl{linguaggi funzionali}. La compilazione di codice sorgente Scala produce codice per l'esecuzione su una JVM.}
