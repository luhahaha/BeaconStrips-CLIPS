...
\parola{IP}{Un Internet Protocol, nelle telecomunicazioni e in informatica, è un protocollo di rete appartenente alla suite di protocolli Internet TCP/IP su cui è basato il funzionamento della rete Internet (riferimento: \url{https://it.wikipedia.org/wiki/Internet_Protocol}).}
