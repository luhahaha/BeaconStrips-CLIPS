...
\parola{JVM}{La macchina virtuale Java è il componente della piattaforma Java che esegue i programmi tradotti in bytecode dopo una prima compilazione (riferimento: \url{https://it.wikipedia.org/wiki/Macchina_virtuale_Java}).}