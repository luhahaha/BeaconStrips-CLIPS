\subsubsection{Procedure}
	...
	\begin{itemize}
		...
		\item \textbf{Approvato}: un documento, ultimata la verifica, deve essere approvato dal \RES. L'approvazione quindi determina lo stato finale della versione del documento.
	\end{itemize}
