...
\subsubsection{Norme}
	...
	\begin{itemize}
		...
		\item \textit{Glossario.sty}: questo file serve per impostare il \textit{Glossario}, che avrà una configurazione diversa dal template standard. %controllare
	\end{itemize}
	...
	\subparagraph{Stile del testo}
		\begin{itemize}
			...
			\begin{itemize}
				...
				\item abbreviazioni.
			\end{itemize}
			\item \\gl{LaTeX}: ogni occorrenza di \\gl{LaTeX}{} va scritta con il comando \texttt{\textbackslash \gl{LaTeX}}
	...
	Nella cartella \file{template} è presente un template da utilizzare per redigere i verbali e sono presenti le seguenti sezioni:
	\begin{itemize}
