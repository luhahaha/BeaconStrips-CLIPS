\subsubsection{Attività}
	\paragraph{Comunicazioni}
		...
		Inoltre è possibile utilizzare il gruppo creato su \gl{Telegram} per comunicazioni interne non inerenti al \gl{progetto}. Per le videoconferenze invece verrà utilizzato \gl{\gl{Google} Hangouts}.
...
\subsubsection{Strumenti}
	...
	Il servizio da utilizzare per i documenti informali è \gl{\gl{Google} Drive}.
	...
	\begin{itemize}
		...
		\item \textbf{Requisiti e casi d'uso}: per il tracciamento dei requisiti si utilizzerà \gl{Trender}. Per quanto riguarda la rappresentazione dei casi d'uso l'editor consigliato è \gl{Star \gl{UML}}; %vedi sezione requisiti 
		\item \textbf{Scadenze}: \gl{\gl{Google} Calenar} verrà utlizzato per segnare le scadenze del gruppo; si riceverà una notifica su \gl{Slack} trenta minuti prima dell'evento;
		\item \textbf{Progetto}: per la realizzazione dei \gl{grafici di \gl{Gantt}} è stato impiegato il programma \gl{GanttProject}.
	\end{itemize}