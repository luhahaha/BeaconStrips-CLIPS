...
\item \UC{UC11.6} l'email inserita non è corretta e viene visualizzato l'errore;
\item \UC{UC11.7} l'email inserita è già in uso e viene visualizzato l'errore.
\end{itemize}}\\\\
\att{Utente non autenticato.}
...
\scensec{ESTENSIONE \begin{itemize}
\item \UC{UC11.8} l'username inserito non è valido e viene visualizzato l'errore;
\item \UC{UC11.9} l'username inserito non è corretto e viene visualizzato l'errore;
\item \UC{UC11.10} l'username inserito è già in uso e viene visualizzato l'errore.
\end{itemize}}\\\\
\att{Utente non autenticato.}
...
\casoduso{UC20.3}{Visualizza errore email non presente nel sistema}
\desc{l'utente visualizza l'errore il quale segnala che la mail inserita non è presente nel sistema.}\\\\
\pre{l'utente ha inserito una mail non presente nel sistema.}\\\\
\post{l'utente ha visualizzato l'errore il quale segnala che la mail inserita non è presente nel sistema.}\\\\
\scen{l'utente visualizza l'errore il quale segnala che la mail inserita non è presente nel sistema}\\\\
\att{Utente non autenticato.}
