\begin{tabella}{!{\VRule}l!{\VRule}l!{\VRule}l!{\VRule}}\intestazionethreecol{Test}{Descrizione}{Operazioni}TV0F1 & L'utente vuole verificare di poter possedere un account.
...
\item accedere alla sezione riguardante la ricerca degli edifici tramite l'apposito bottone; 
\item inserire un raggio in cui non sia presente nessun edificio con percorsi; 
\item verificare che venga visualizzato l'invito ad inserire un raggio più ampio. 
\end{enumerate} \\ 
TV2F6.2.1.4 & L'utente vuole verificare che venga visualizzata una breve descrizione dell'edificio e dei percorsi presenti. & Viene richiesto di: \begin{enumerate} 
\item accedere alla sezione riguardante la ricerca degli edifici tramite l'apposito bottone; 
\item selezionare un edificio tra quelli della lista; 
\item verificare che venga visualizzata una breve descrizione dell'edificio e dei percorsi presenti. 
\end{enumerate} \\ 
