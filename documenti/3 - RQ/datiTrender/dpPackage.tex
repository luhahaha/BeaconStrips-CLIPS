...
\classeMetodo{isLogged}{}{boolean}{restituisce \textit{true} se l'utente è loggato, ovvero se è salvato un token in locale, "false" altrimenti}
...
\end{classeMetodoArgomenti}
\classeMetodo{sendResponse}{initialization}{void}{metodo di supporto che reinizializza loggedUser quando richiesta e invoca il metodo onResponse del listener, inviando come risposta "true"}
\begin{classeMetodoArgomenti}
