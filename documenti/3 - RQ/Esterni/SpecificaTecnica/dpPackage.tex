...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.3]{img/package/png/client--viewcontroller--games1.png}
\caption{Prima parte schema package client::viewcontroller::games}
 \end{figure}
 \begin{figure}[h!]
 	\centering
 	\includegraphics[scale=0.3]{img/package/png/client--viewcontroller--games2.png}
 	\caption{Seconda parte schema package client::viewcontroller::games}
 \end{figure}
 \begin{figure}[h!]
 	\centering
 	\includegraphics[scale=0.3]{img/package/png/client--viewcontroller--games3.png}
