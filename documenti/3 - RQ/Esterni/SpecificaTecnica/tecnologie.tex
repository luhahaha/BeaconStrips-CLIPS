...
\subsection{GraphQL} 
	...
	\begin{itemize} %TODO: finire i vantaggi e gli svantaggi, specialmente questi ultimi
		\item \textbf{Vantaggi:}
			\begin{itemize}
				\item è un linguaggio libero e gratuito;
				\item semplifica l'interazione con il database SQL;
				\item \item è disponibile online una spiegazione di come funziona e di come usarlo; %volevo evitare di dire che possiede una documentazione molto dettagliata perché mi da l'idea che non sia vero, probabilmente perché non c'è bisogno di scrivere più di tanto
			\end{itemize}
		\item \textbf{Svantaggi:}
			\begin{itemize}
