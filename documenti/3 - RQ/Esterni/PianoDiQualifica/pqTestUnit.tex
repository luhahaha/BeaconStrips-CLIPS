\begin{tabella}{!{\VRule}l!{\VRule}X[1,b,l]!{\VRule}l!{\VRule}}
	...
	TU30 & Si verifica che la costruzione dei test avvenga correttamente & N.I. \\ %data.TestBuilder, da eliminare perché viene già verificato dal TU16
	...
	TU32 & Si verifica che la costruzione dell'algoritmo per il calcolo del punteggio del test avvenga correttamente & N.I. \\ %data.ScoringAlgorithmFactory, da eliminare perché viene già verificato dal TU16
