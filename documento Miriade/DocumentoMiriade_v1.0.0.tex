...
\begin{diario} %TODO: valutare se inserire un nuovo comando per il diario senza il ruolo
	\modifica{Andrea Grendene}{\PRJ}{Terminata sezioni \hyperref[sec:valutazione]{valutazione}\ e \hyperref[sec:miglioramento]{miglioramento}. Aggiunto prova Proximity e aggiornato prova RA in \hyperref[sec:prove]{prove}}{2016-09-28}{0.0.4}
